{include file='head.tpl' title='Recover Password'}
<body>
    ...
    <div class="container">
        ...
        <p>Did you forget your password? Don't worry, introduce your email below and we'll send you a link so you can choose a new one.</p>
